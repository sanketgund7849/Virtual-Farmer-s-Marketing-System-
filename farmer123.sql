...
--
-- Host: localhost    Database: farmers_market0777
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`farmer_id`) REFERENCES `farmers` (`farmer_id`)
...
-- Dump completed on 2026-09-07 11:24:03
